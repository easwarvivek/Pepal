...
class SoftwareTransfer(Protocol):
    ...
    def send_encryptions9(self,input):
        print("SENDER 9")
        print("number of class files: ", show_jar_classes('watermarkedJARs/HelloWorld0_wm0.jar'))
        fp0 = open('watermarkedJARs/HelloWorld0_wm0.jar','rb')
        fp1 = open('watermarkedJARs/HelloWorld0_wm1.jar','rb')
        content0 = fp0.read()
        content1 = fp1.read()
